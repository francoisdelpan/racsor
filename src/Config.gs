var RacsorConfig = (function () {
  ...
  SHEET_HEADERS[SHEETS.TRANSACTIONS] = ['id', 'contract_number', 'folder_name', 'client_first_name', 'client_last_name', 'client_full_name', 'client_phone', 'client_email', 'pickup_date', 'return_date', 'status', 'total_amount_ttc', 'total_deposit_amount', 'drive_folder_id', 'generated_contract_file_id', 'signed_contract_file_id', 'pickup_calendar_event_id', 'return_calendar_event_id', 'created_by', 'created_at', 'updated_at', 'cancelled_at'];
  SHEET_HEADERS[SHEETS.TRANSACTION_ITEMS] = ['id', 'transaction_id', 'product_id', 'product_label_snapshot', 'quantity', 'pricing_rule_id', 'unit_price_ttc', 'line_amount_ttc', 'deposit_unit_amount', 'deposit_line_amount'];
